...
class _CastMediaState extends State<CastMedia> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.castMedia.length == 0
        ? Container(
            ...
            child: Center(
              child: Text(
                ...
                style:
                    TextStyle(fontSize: 22.0, fontWeight: FontWeight.bold, color: Colors.grey[300]),
              ),
            ),
          )
        : Container(
                  ...
                  children: _castMeida.map((poster) {
                    ...
                    return GestureDetector(
                      onTap: () => Navigator.push(context,
                          CupertinoPageRoute(builder: (_) => MovieDetailScreen(movieID: media.id))),
                      child: Container(
